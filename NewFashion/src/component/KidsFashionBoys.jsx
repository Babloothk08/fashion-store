...
function KidsFashionBoys({handleAddProductToCart}) {
  ...
  const filterData = data.filter((items) => items.category === "BoyskidsWear");
        ...
        >
          ...
          <div className="  p-4">
            ...
            <div className="flex justify-between mt-3">
              <button className=" px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition cursor-pointer" onClick={() => handleAddProductToCart(item)}>
                 Add To Cart
              </button>
...
export default KidsFashionBoys;
